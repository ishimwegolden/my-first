...
<body>
    <ul>
        ...
        <li class="dropdown">
            <a href="rooms.php" class="dropdowns">rooms & suites</a>
    ...
    <li class="dropdown">
            <a href="dinning.php" class="dropdowns">dinning</a>
            <div class="dropdown-content">
        ...
        <li class="dropdown">
            <a href="meeting.php" class="dropdowns">meeting</a>
             <div class="dropdown-content">
        ...
        <li><a href="gallery.php">Gallery</a></li>
            <li class="login1" style="padding-left: 40rem"><a href="login.php">login</a></li>
</ul>
...
<div class="romantic">
  <img src="ron1.jpg" width="70.3%" height="72%" class="mucyo" style="cursor: crosshair;">
...
<div class="heading1">
  <h2 style="margin-left:-4rem; font-size: 17px;">the perpetrators of the act</h2>
     ...
     <div class="chart">
 <br>
<input type="text"placeholder="enter Names" name="names" style="margin-left: 30rem; margin-top: -1rem;">
<br>
<input type="text"placeholder="enter Email" name="email" style="margin-left: 50rem; margin-top: -4.8rem;">
<br>
<textarea style="border-left: none; border-right: none; border-top: none; width: 40rem; height: 10rem; margin-left: 30rem; background-color: transparent; font-family: argerian; color:darkolivegreen; font-weight: bold; font-size: 17px;" placeholder="Message" name="message"></textarea>
<br>
